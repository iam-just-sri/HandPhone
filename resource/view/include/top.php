...
<html lang="en">
	<head>
		...
		<title> HandPhone Store | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/faviconFront.png">
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/ind.png" alt="Bangladesh flag">INDIA</a>
							</div>
						</div>
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 80px;" src="public/assets/images/favicon/brand_logo_front.png" alt="HandPhone Store Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+91 9791465400</strong></a>
							</div>
