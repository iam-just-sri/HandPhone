					...
					<div class="container">
						<div class="row">
							<div class="col-lg-2 col-md-6">
								<div class="widget">
									<h4 class="widget-title" style="margin-left: 30px;">My Account</h4>
									<ul class="links">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>HandPhone Store's infrastructure is manipulate with MVC Pattern and it's developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Udumalpet, TamilNadu, India - 642126</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+91 9791465400</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">ecomtest@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="" target="_blank"> Srinath G</a>
						</p>
						<div class="social-icons">
							<a><img style="height: 45px; padding-left: 16px;" src="public/assets/images/icons/payment_list_1.png" alt=""></a>
						</div>
						<div class="social-icons">
							<a href="index.php"style="margin: 0px 10px;">
								<img src="public/assets/images/icons/profile.png" class="rounded-circle" style="width:32px; height:32px;">
							</a>				
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						<div class="modal-header">
							<img src="public/assets/images/favicon/admin_logo.png" alt="Logo" class="logo-newsletter">
						</div>
						<div class="modal-body">
							<h2>BE THE FIRST TO KNOW</h2>
							<p>Subscribe to the <b> HandPhone Store Online Shopping</b>  newsletter <br/> to receive timely updates from your favourite products.</p>
							<form action="" method="post">
								<div class="row">
