						...
						<div class="row">
							<div class="col-md-3 col-xs-2">
								<div class="invoice-title">
									<h1>invoice</h1>
									<img class="logo-print" src="public/assets/images/favicon/logofront_.png" alt="" style="width: 220px; height: 60px;">
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-xs-5 invoice-block pull-right">
							<ul class="unstyled amounts">
								...
								<li>Delivery charges :
									<?php
									if($getdetailsResult[0]['sub_total']>=5999)
									{
										echo $GLOBALS['CURRENCY'] . " " . 0;
									}
									else
									{
										echo $GLOBALS['CURRENCY'] . " " . 499;
									}
									?>
								</li>
								<li>TAX 
						...
						<div class="invoice-header">
							<div class="row">
								<div class="col-md-3 col-xs-2">
									<div class="invoice-title">
										<h1>invoice</h1>
										<img class="logo-print" src="public/assets/images/favicon/_logofront_.png" alt="" style="width: 60px; height: 60px;">
									</div>
								</div>
								<div class="invoice-info  col-md-9 col-xs-10">
									<div style="padding-left: 340px;">
