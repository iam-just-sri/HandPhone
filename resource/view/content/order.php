				...
				<?php
					...
					if(isset($_POST['submit_order']))
					{
						...
						<div class="d-flex justify-content-center">
							<img src="public/assets/images/success_.png" alt="" class="img-fluid">
						</div>
						...
						<ul class="checkout-steps">
							<li>
								...
								<form action="payments.php" method="post">
									...
									<div class="form-group required-field">
										<label>State</label>
										<input type="text" name="shipadd_state" class="form-control" value="Tamilnadu">
									</div>
									<div class="form-group required-field">
										<label>Country</label>
										<input type="text" name="shipadd_cntry" class="form-control" value="India">
									</div>
									<div class="form-group required-field">
