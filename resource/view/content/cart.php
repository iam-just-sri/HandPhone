					...
					<table class="table table-cart">
						<thead>
							<tr>
								...
								<th class="price-col">Subttotal</th>
								<th >Action</th>
							</tr>
						</thead>
						<tbody>
						...
						<tfoot>
							<tr>
								...
								<td>
									...
									if($cartSubtotal<=5999)
									{
										echo $GLOBALS['CURRENCY'] . " " . $grandTotal = round((($cartSubtotal + $tax) - @$_SESSION['SSCF_DISCOUNT_AMOUNT'])+499);
									}
									else
									{
										echo $GLOBALS['CURRENCY'] . " " . $grandTotal = round((($cartSubtotal + $tax) - @$_SESSION['SSCF_DISCOUNT_AMOUNT']));
									}
									?>
