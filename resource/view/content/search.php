...
$arrayKeyword = explode(" ", $_SESSION['search_keywords']);
...
$searchedProductList = $searchCtrl->searchProductLimit($_SESSION['search_keywords']);
}
// $que = "SELECT * from products where product_tags like '%keywords%'";
// $res = mysqli_query($con,$que);
// $row6 = mysqli_fetch_assoc($res);

// echo $row6['product_master_image'];
...
<main class="main">
	<div class="banner banner-cat" style="background-image: url('public/assets/images/yellow.jpg');">
		<div class="banner-content container">
			<h2 class="banner-subtitle text-dark"><span style="color:red;">check out our latest collection <?= date("Y"); ?></span></h2>
					...
					<?php 
						...
						if(empty($searchedProductList))
						{
							echo '<div class="d-flex justify-content-center">
										<img src="public/assets/images/sorry_.png" style="width: auto; height:400px;"/>
									</div>';
						}
					?>
