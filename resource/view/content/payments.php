...
if(isset($_POST['proceed_to_payment']))
{
	if(@$_SESSION['SSCF_login_id'] > 0)
	{
		...
		$columnValue["shipcstmr_state"] = $_POST['shipadd_state']; 
...
if(isset($_POST['proceed_to_payment']) || isset($_POST['update_shipping']))
{
	...
	{
		$server_name = 'http://localhost/www.handphone.com/';
	} 
	else 
	{
		$server_name = 'http://www.handphone.com/';
	}
									...
									<form method="post" action="status.php">
										<div class="form-group-custom-control">
											<div class="custom-control custom-checkbox">
												...
												<label class="custom-control-label" for="address-save"><h4>Cash On Delivery</h4></label>
												
											</div>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" name="payment_values2" value="2" class="custom-control-input" id="address-save1" disabled>
												<label class="custom-control-label" for="address-save"><h4>UPI</h4></label>
											</div>

											<div class="custom-control custom-checkbox">
												<input type="checkbox" name="payment_values2" value="2" class="custom-control-input" id="address-save1" disabled>
												<label class="custom-control-label" for="address-save"><h4>Debit/Credit Cards</h4></label>
											</div>
											
											<input type="submit" name="cash_on_delivery" class="btn btn-block btn-sm btn-primary" Value=Confirm disabled>
											<script>
