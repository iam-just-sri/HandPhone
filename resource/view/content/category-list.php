	...
	<div class="banner banner-cat" style="background-image: url('<?= $GLOBALS['BANNER_DIRECTORY'] . $categoryResult[0]['subcategory_banner']; ?>');">
		<div class="banner-content container">
			<h2 class="banner-subtitle">
				<span style="color:red;">check out our latest collection <?= date("Y"); ?></span>
			</h2>
				...
				<?php
					...
					if(!empty($categoryDetails))
					{
						foreach($categoryDetails AS $eachCategory)
						{
							...
							if(strlen($eachCategory['product_details']) > -1)
							{
								$prodDes = substr($eachCategory['product_details'], 0, -1) . ' ....';
							}
