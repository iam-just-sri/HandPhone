	...
	<div class="container">
		<div class="map">
			...
			<script type="text/javascript">
				...
				var marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(23.617928, 90.4864331)});infowindow = new google.maps.InfoWindow({content:""});google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);
			</script> 
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">+91 9791465400</a></p>
						<p>Mobile Number</p>
					</div>
					<div>
					...
					<div>
						...
						<p><a href="mailto:#">ecomtest@gmail.com</a></p>
					</div>
					<div>
						<i class="icon-skype"></i>
						<p><a href="">Srinath G</a></p>
