...
$columnName["4"] = "shippings.shipcstmr_streetadd";
$columnName["5"] = "shippings.shipcstmr_city";
$columnName["6"] = "shippings.shipcstmr_zip";
$columnName["7"] = "shippings.shipcstmr_state";
						...
						<table  class="display table table-bordered table-striped" id="dynamic-table">
							<thead>
								<tr>
									...
									<th style="width: 12%"> Customer Email </th>
							...
							<tbody>
								<?php 
									...
									{
										$addSummary = $eachOrder['shipcstmr_streetadd'] . ", " . $eachOrder['shipcstmr_city'] . "-" . $eachOrder['shipcstmr_zip'] . ", ".$eachOrder['shipcstmr_state']. ", ". $eachOrder['shipcstmr_country']; 
								?>
