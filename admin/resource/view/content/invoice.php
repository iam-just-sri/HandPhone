<?php
	...
	if(isset($_POST['invoice_details']))
	{
		...
		$columnName["9"] = "shippings.shipcstmr_streetadd";
		$columnName["10"] = "shippings.shipcstmr_city";
		$columnName["11"] = "shippings.shipcstmr_zip";
		$columnName["12"] = "shippings.shipcstmr_state";
					...
					<div class="panel-body invoice">
						...
						<div class="invoice-header">
							<div class="invoice-title col-md-3 col-xs-2" style="margin-top: 0px;">
								<h1>invoice</h1>
								<img class="logo-print" src="./../public/assets/images/favicon/brand_logo_front.png" alt="" style="width: 220px; height: 60px; margin-top: -65px; margin-bottom: -5px;">
							</div>
								...
								<?php
									echo '<h2>'. $invoiceDetails[0]['shipcstmr_name'] .'</h2>
											<p>Phone: +91 '. 
												...
												$invoiceDetails[0]['shipcstmr_state'] .'<br>'. 
						...
						<div class="row">
							<div class="col-md-8 col-xs-7 payment-method">
								...
								<p style="margin-top: 24px; font-style: normal; font-size: 17px;" class="inv-label"> 
									...
									<?php echo $getAmount->inAwords($invoiceDetails[0]['grand_total']) . ' RUPEES ONLY'; ?>
								</p>
