...
<html lang="en">
	...
	<?php
		...
		<link rel="shortcut icon" href="../public/assets/images/favicon/admin_logo.png" type="image/png">
			...
			<div class="left-side sticky-left-side">														
				<div class="logo">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/shop_logo_admin.png" alt="" height="36px">
					</a>
				</div>
				<div class="logo-icon text-center">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/backend.png" alt="" height="34px" width="34px">
					</a>
				</div>
